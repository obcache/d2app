...
cfgLoad(&cfg, &ui) {
	global
	cfg.dbFileName := A_ScriptDir . "\d2app.DB"
	...
	cfg.MainGui					:= IniRead(cfg.file,"System","MainGui","MainGui")
	cfg.MainScriptName			:= IniRead(cfg.file,"System","MainScriptName", "d2app")
...
exitFunc(ExitReason,ExitCode) {
	...
	{
		Result := MsgBox("Are you sure you want to`nTERMINATE d2app?",,4)
		if Result = "No" {
