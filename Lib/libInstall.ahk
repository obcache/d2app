		...
		if StrCompare(A_ScriptDir,InstallDir)
  		{
			...
			fileInstall("./img/d2app.ico",installDir "/img/d2app.ico")
			pbConsole("`nINSTALL COMPLETED SUCCESSFULLY!")
			installLog("Copied Assets to: " InstallDir)	
		
			fileCreateShortcut(installDir "/d2app.exe", A_Desktop "\d2app.lnk",installDir,,"d2app - Destiny2 Companion",installDir "/img/d2app.ico")
			fileCreateShortcut(installDir "/d2app.exe", A_StartMenu "\Programs\d2app.lnk",installDir,,"d2app - Destiny2 Companion",installDir "/img/d2app.ico")
