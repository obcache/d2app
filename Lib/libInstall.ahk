		...
		if StrCompare(A_ScriptDir,InstallDir)
  		{
			...
			FileInstall("./Img/button_d2Checklist.png",InstallDir "/Img/button_DIM.png",1)
			FileInstall("./Img/button_d2Checklist_down.png",InstallDir "/Img/button_DIM_down.png",1)
			FileInstall("./Img/button.png",InstallDir "/Img/button_DIM.png",1)
