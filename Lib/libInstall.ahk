		...
		if StrCompare(A_ScriptDir,InstallDir)
  		{
			...
			fileInstall("./img/d2app_icon.ico",installDir "/img/d2app_icon.ico",1)
			pbConsole("`nINSTALL COMPLETED SUCCESSFULLY!")
			installLog("Copied Assets to: " InstallDir)	
		
			fileCreateShortcut(installDir "/d2app.exe", A_Desktop "\d2app.lnk",installDir,,"d2app - Destiny2 Companion",installDir "/img/d2app_icon.ico")
			fileCreateShortcut(installDir "/d2app.exe", A_StartMenu "\Programs\d2app.lnk",installDir,,"d2app - Destiny2 Companion",installDir "/img/d2app_icon.ico")
